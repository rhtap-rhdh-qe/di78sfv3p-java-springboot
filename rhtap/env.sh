...
export IMAGE_URL=${IMAGE_URL-rhtap-quay-quay-rhtap-quay.apps.rosa.kx-9f445f3c64.swbu.p3.openshiftapps.com/rhtap/rhtap-qe:$CI_TYPE-$TAG}
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.kx-9f445f3c64.swbu.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.kx-9f445f3c64.swbu.p3.openshiftapps.com}
